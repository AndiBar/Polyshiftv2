...
{	
	...
	{
		this.texture = new Texture( gl, 256, 256, Texture.TextureFilter.Nearest, Texture.TextureFilter.Nearest, Texture.TextureWrap.ClampToEdge, Texture.TextureWrap.ClampToEdge );
	...
	public class Text
	{
		...
		public void render( )
		{
			...
			texture.bind();
			mesh.render(Mesh.PrimitiveType.Triangles);
		}		
